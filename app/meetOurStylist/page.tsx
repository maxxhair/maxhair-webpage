...
function page() {
      ...
      <div className="py-[32px] px-[20px] mt-[80px] w-full lg:pt-[100px] bg-[#FAFAFA] flex lg:flex-row flex-col gap-[20px] justify-center lg:items-start items-center">
        ...
        <div className="flex flex-col justify-center items-center gap-[10px] md:w-[60%] w-[80%] h-[70%] py-[10px] font-[400] bg-[#E3D6C5] text-[#885C46] px-[20px]">
          <div className="flex flex-col xl:w-[70%] lg:w-[80%] w-[90%] justify-center py-[40px] gap-[10px]">
            ...
            <div className="mt-4"><SendMoreInfo /></div>
  ...
  Chanel is a licensed cosmetologist, providing services over 20 years from the Dominican Republic, New York, and now in Houston, TX. Dominican hairstyle expert, specializing in color, balayage, highlights, and hair extensions. She is the owner of CSCOSMETOLOGY.

  Expertise in all types of hair and hair extension techniques like micro ring, wefts, tape, and more.
  Their goal is to continue educating more people who can work with all types of hair from 1A to 4C and continue teaching various extension techniques.

  <p><span className="font-bold">Website:</span> <a href="https://www.cscosmetology.com" className="text-blue-600">www.cscosmetology.com</a></p>
  <p><span className="font-bold">Instagram:</span> <a href="https://www.instagram.com/cs.cscosmetology" className="text-blue-600">@cs.cscosmetology</a></p>
</div>
      ...
      <div className="py-[32px] px-[20px]  w-full  bg-[#FAFAFA] min-h-[70vh] flex lg:flex-row flex-col gap-[20px] justify-center lg:items-start items-center">
        ...
        <div className="flex flex-col justify-center items-center gap-[10px] md:w-[60%] w-[80%] h-[70%] py-[10px] font-[400] bg-[#E3D6C5] text-[#885C46] px-[20px]">
          <div className="flex flex-col xl:w-[70%] lg:w-[80%] w-[90%] justify-center py-[40px] gap-[10px]">
            ...
            <span className="lg:body-large md:body-medium body-small">
            What started as a hobby, has now grown into a passion for hairdressing at, First Class Hair Braiding salon in boston. Cecile has 15 years of experience in hairstyling, weave and braiding. She is an expert in braiding and color techniques.
            </span>
